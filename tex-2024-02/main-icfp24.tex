...
In line \ACom{(4)} and \ACom{(7)}, we can use the {\AFun{≡-subst-removal}} lemma
...
lift the {\AFun{≡-subst-removal~F₂~E₂}~\_} equality under the application.

Interestingly, a unary {\AFun{cong}} lemma is not sufficient to lift the {\AFun{≡-subst-removal}}
under the \ACode{\AFun{Esub}~σ₁*~σ}, and instead the binary {\AFun{cong₂}} lemma needs to be used:
