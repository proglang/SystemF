...
We define an intrinsically-typed small-step reduction relation in the usual way.
\SmallStepSingleReduction

The same lemmas as for the big-step semantics serve to prove the soundness of small-step reduction.
\SmallStepSoundness
...
In consequence, the identical definitions yield a logical relation for the small-step semantics.
